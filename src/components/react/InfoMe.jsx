    ...
    <>
      <section id='home' className='relative w-screen h-screen bg-white grid grid-cols-2 dark:bg-[#0F0101]'>
        ...
        <div className='flex gap-9 flex-col justify-center pl-20'>
          ...
          <p className='animate-fade animate-once animate-duration-[2000ms] animate-normal animate-delay-1000 text-xl text-gray-800 font-Hind_Guntur font-light max-w-lg transition-colors duration-300 dark:text-gray-200'>¿Por qué dejar tus ideas en el aire cuando puedes hacerlas realidad?</p>
          {buttons}
        </div>
        <AnimateImg />
      </section>
