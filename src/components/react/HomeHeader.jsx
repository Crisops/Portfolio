...
const HomeHeader = () => {
  ...
  return (
    <header className='fixed top-0 left-0 py-5 px-20 w-full flex justify-between items-center backdrop-blur-sm z-[50] 2xl:pl-10 xl:pl-10 max-[1024px]:px-10 max-sm:px-5'>
